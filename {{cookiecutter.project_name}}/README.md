...
To finalize the set-up for publishing to PyPI, see [here](https://fpgmaas.github.io/cookiecutter-py-quarto/features/publishing/#set-up-for-pypi).
For activating the automatic documentation with MkDocs, see [here](https://fpgmaas.github.io/cookiecutter-py-quarto/features/mkdocs/#enabling-the-documentation-on-github).
To enable the code coverage reports, see [here](https://fpgmaas.github.io/cookiecutter-py-quarto/features/codecov/).
...
For more details, see [here](https://fpgmaas.github.io/cookiecutter-py-quarto/features/cicd/#how-to-trigger-a-release).
{%- endif %}
